...
lr_config = dict(
    ...
    warmup_iters=10,
    warmup_ratio=0.001,
    step=[4*lr_mult, 6*lr_mult, 12*lr_mult])
...
train_root = ['/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/poisson_v1',
            '/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/color_v1']
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=['/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/poisson_v1/annotations.txt',
                '/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/color_v1/annotations.txt'],
        img_prefix=['/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/poisson_v1/images',
...
model = dict(
    ...
    backbone=dict(
        type='MobileNetV1',
        block_cfg=dict(
            stage_blocks=(3, 2, 1, 5), stage_planes=[32, 48, 48, 160, 216,
                                                     312])),
    neck=dict(
        type='PAFPN',
