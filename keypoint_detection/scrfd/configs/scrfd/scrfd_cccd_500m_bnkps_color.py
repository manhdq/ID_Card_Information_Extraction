optimizer = dict(type='SGD', lr=0.000625, weight_decay=0.0005)
...
lr_config = dict(
    ...
    warmup_iters=10,
    warmup_ratio=0.001,
    step=[4*lr_mult, 6*lr_mult, 8*lr_mult, 12*lr_mult])
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/color_v1/annotations.txt',
        img_prefix='/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/color_v1/images',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(type='LoadAnnotations', with_bbox=True, with_keypoints=True),
            # dict(
