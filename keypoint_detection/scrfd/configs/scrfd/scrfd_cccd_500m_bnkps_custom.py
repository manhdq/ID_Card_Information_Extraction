...
lr_config = dict(
    ...
    warmup_iters=10,
    warmup_ratio=0.001,
    step=[4*lr_mult, 6*lr_mult, 10*lr_mult])
total_epochs = 12*lr_mult
...
#             '/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/addition']
...
data = dict(
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file='/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/addition/annotations.txt',
        img_prefix='/home/manhdq/ID_Card_Information_Extraction/datasets/cccd/addition/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_keypoints=True),
            dict(
