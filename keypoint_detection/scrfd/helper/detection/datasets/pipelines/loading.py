...
from ....general.fileio import FileClient
from ....general.image import imfrombytes
...
class LoadImageFromWebcam(LoadImageFromFile):
    ...
    def __call__(self, results):
        ...
        results['img'] = img
        results['img_shape'] = img[0].shape if isinstance(img, list) else img.shape
        results['ori_shape'] = img[0].shape if isinstance(img, list) else img.shape
        results['img_fields'] = ['img']
        return results
