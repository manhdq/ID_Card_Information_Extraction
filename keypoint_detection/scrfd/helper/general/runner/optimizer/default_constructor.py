...
from ....general.utils import _BatchNorm, _InstanceNorm, is_list_of
from ....general.utils.ext_loader import check_ops_exist
from .utils import TORCH_OPTIMIZERS
...
class DefaultOptimizerConstructor:
    ...
    def __call__(self, model: nn.Module):
        ...
        if not self.paramwise_cfg:
            ...
            return TORCH_OPTIMIZERS[cfg_type](**cfg)
