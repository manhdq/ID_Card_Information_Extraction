...
from ..version import __version__ as general_version
...
def collect_env():
    ...
    if cuda_available:
        ...
        from .parrots_wrapper import _get_cuda_home
    ...
    env_info['MMCV'] = general_version

    try:
        from ..ops.info import get_compiler_version, get_compiling_cuda_version
    except ModuleNotFoundError:
