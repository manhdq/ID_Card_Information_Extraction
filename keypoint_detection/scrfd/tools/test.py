...
from helper.general.fileio import dump
from helper.general.cnn import fuse_conv_bn
from helper.general.parallel import MMDataParallel, MMDistributedDataParallel
from helper.general.runner import (get_dist_info, init_dist, load_checkpoint,
                                wrap_fp16_model)

from helper.detection.apis import multi_gpu_test, single_gpu_test
...
def main():
    ...
    if cfg.get('custom_imports', None):
        from helper.general.utils import import_modules_from_strings
